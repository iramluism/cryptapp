...
REDIS_SERVER_HOST = config("TEST_REDIS_SERVER_HOST", default="localhost")
REDIS_SERVER_PORT = config("TEST_REDIS_SERVER_PORT", default=6379)
MESSAGE_BROKER_DB = config("TEST_MESSAGE_BROKER_DB", default=0)
REDIS_CACHE_DB = config("TEST_CACHE_DB", default=1)
